...
<body>
    ...
    $(document).ready(function () {
        $("#myForm").submit(function (e) {
            ...
            var formData = $("#myForm").serialize(); // Mengubah data form menjadi string URL-encoded
            
            // Kirim data ke server PHP menggunakan AJAX
            $.ajax({
                url: "proses_lanjut.php", // File PHP yang akan memproses data
                type: "POST",
                data: formData,
                success: function (response) {
                    // Tampilkan hasil (response) dari server di div "hasil"
                    $("#hasil").html(response); 
                },
                error: function () {
